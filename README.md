...
[![Launch on Nextflow Tower](https://img.shields.io/badge/Launch%20%F0%9F%9A%80-Nextflow%20Tower-%234256e7)](https://tower.nf/launch?pipeline=https://github.com/nf-core/hybrider)
...
**nf-core/hybrider** is a bioinformatics pipeline that ...
...
For more details and further functionality, please refer to the [usage documentation](https://nf-co.re/hybrider/usage) and the [parameter documentation](https://nf-co.re/hybrider/parameters).

## Pipeline output

To see the results of an example test run with a full size dataset refer to the [results](https://nf-co.re/hybrider/results) tab on the nf-core website pipeline page.
For more details about the output files and reports, please refer to the
[output documentation](https://nf-co.re/hybrider/output).

## Credits

nf-core/hybrider was originally written by Lucas de Freitas Lacerda.
...
For further information or help, don't hesitate to get in touch on the [Slack `#hybrider` channel](https://nfcore.slack.com/channels/hybrider) (you can join with [this invite](https://nf-co.re/join/slack)).
